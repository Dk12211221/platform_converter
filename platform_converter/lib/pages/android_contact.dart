import 'dart:math';
import 'package:contact_app_final/model/Contact.dart';
import 'package:contact_app_final/screens/EditScreen.dart';
import 'package:contact_app_final/Global.dart';
import 'package:contact_app_final/model/ThemeProvider.dart';
import 'package:contact_app_final/pages/ios_contact.dart';
              ...
              child: Consumer(
                  builder: (context,ContactList,child) {
                    ...
                    return ElevatedButton(
                      style: ButtonStyle(
                        backgroundColor: WidgetStateProperty.all<Color>(Color(0xff6A53A7)),
                      ),
                      onPressed: () {
